...
export default function AccountInfo({ account, userName, transactions, setShowDepositModal, setShowWithdrawModal, setShowCloseModal }) {
  const navigate = useNavigate();

  const downloadPdf = () => {
    console.log("Téléchargement PDF pour le compte :", account);
    ...
    console.log("Table body pour PDF :", tableBody);
